...
/// 群文本消息
pub const MSG_TYPE_GROUP_TEXT: u16 = 10;

/// 群图片消息
pub const MSG_TYPE_GROUP_IMAGE: u16 = 11;

/// 群文件消息
pub const MSG_TYPE_GROUP_FILE: u16 = 12;

/// 群通知消息（成员变更等）
pub const MSG_TYPE_GROUP_NOTIFICATION: u16 = 13;
